...
# Importe les modules de logique ET le fichier d'assets
...
class RDR2MLOToolSuite(customtkinter.CTk):
    ...
    HOVER_COLOR = "#e63939" # Couleur de survol pour les boutons d'action
    ...
    def __init__(self):
        ...
        # --- Attributs pour l'animation du log ---
        self.log_queue = []
        self.is_logging_anim = False
        
        self.title("RedM MLO Tool Suite")
        
        # --- AJOUT : Définition de l'icône de la fenêtre et de la barre des tâches ---
        try:
        ...
        # Configure la ligne 2 (conteneur principal) pour qu'elle s'étende
        ...
        self._create_footer() # Création du footer
    ...
    def _create_footer(self):
        ...
        footer_frame.grid(row=3, column=0, padx=10, pady=(0, 5), sticky="ew") # Padding réduit ici

        # --- Partie gauche : Version ---
        ...
        # --- Partie centrale : Crédits (placé au centre absolu) ---
    ...
    def select_ytyp_file(self):
        ...
        try:
            ...
            self.clear_log()
            self.log_instant(assets.LOGO_MANIFEST)
            self.log_instant("") # Espacement ajouté
